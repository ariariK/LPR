...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        label->setGeometry(QRect(20, 150, 491, 51));
        QFont font;
        ...
        label_2->setGeometry(QRect(20, 270, 491, 51));
        label_2->setFont(font);
        label_2->setFrameShape(QFrame::Box);
        label_3 = new QLabel(centralwidget);
        label_3->setObjectName(QString::fromUtf8("label_3"));
        label_3->setGeometry(QRect(20, 330, 491, 51));
        label_3->setFont(font);
        label_3->setFrameShape(QFrame::Box);
        label_4 = new QLabel(centralwidget);
        label_4->setObjectName(QString::fromUtf8("label_4"));
        label_4->setGeometry(QRect(20, 390, 491, 51));
        label_4->setFont(font);
        label_4->setFrameShape(QFrame::Box);
        label_5 = new QLabel(centralwidget);
        label_5->setObjectName(QString::fromUtf8("label_5"));
        label_5->setGeometry(QRect(20, 10, 1061, 61));
        QFont font1;
        ...
        label_usb_f2->setGeometry(QRect(580, 270, 211, 51));
        ...
        label_usb_f3->setGeometry(QRect(580, 330, 211, 51));
        ...
        label_usb_r3->setGeometry(QRect(580, 390, 211, 51));
        ...
        label_usb_f2_conn->setGeometry(QRect(860, 270, 211, 51));
        ...
        label_usb_f3_conn->setGeometry(QRect(860, 330, 211, 51));
        ...
        label_usb_r3_conn->setGeometry(QRect(860, 390, 211, 51));
        ...
        label_7->setGeometry(QRect(25, 110, 481, 21));
        label_7->setFont(font);
        label_7->setAlignment(Qt::AlignCenter);
        label_8 = new QLabel(centralwidget);
        label_8->setObjectName(QString::fromUtf8("label_8"));
        label_8->setGeometry(QRect(580, 110, 211, 21));
        label_8->setFont(font);
        label_8->setAlignment(Qt::AlignCenter);
        label_9 = new QLabel(centralwidget);
        label_9->setObjectName(QString::fromUtf8("label_9"));
        label_9->setGeometry(QRect(860, 110, 211, 21));
        label_9->setFont(font);
        label_9->setAlignment(Qt::AlignCenter);
        label_eth0_conn = new QLabel(centralwidget);
        label_eth0_conn->setObjectName(QString::fromUtf8("label_eth0_conn"));
        label_eth0_conn->setGeometry(QRect(860, 150, 211, 51));
        ...
        label_eth1_conn->setGeometry(QRect(860, 210, 211, 51));
